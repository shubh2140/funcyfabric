...
//                   <br />
//                   Wholesale Inquiries: wholesale@funcyfabric.com
//                   <br />
//                   Press: press@funcyfabric.com
//                 </p>
//               </div>
//             </div>
//             <div className="flex items-start">
...
//       {/* Map */}
//       <div className="h-[400px] bg-gray-200 rounded-lg mb-12 flex items-center justify-center">
//         <p className="text-gray-500">Map would be embedded here in a real application</p>
//       </div>
//     </div>
//   )
// }
